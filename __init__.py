...
def test_route_agent(title, start, goal, speed, problem):
    ...
    print(title, "A* Solution\tTravel time: ", astar_time, "\tPath: ", astar_result)
    print(title, "Simulated Annealing\tTravel time: ", simulated_annealing_time, "\tPath: ", simulated_annealing_result)
